...
//
// $Id: LuksanVlcek3.hpp 1327 2008-09-18 19:01:17Z andreasw $
//
...
/** Implementation of Example 5.3 from "Sparse and Parially Separable
...
public:
  ...
  LuksanVlcek3(Number g_l, Number g_u);
...
private:
  ...
  //@{
  LuksanVlcek3();
  LuksanVlcek3(const LuksanVlcek3&);
  LuksanVlcek3& operator=(const LuksanVlcek3&);
  //@}
