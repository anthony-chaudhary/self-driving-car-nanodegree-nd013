...
//
// $Id: LuksanVlcek6.hpp 1327 2008-09-18 19:01:17Z andreasw $
//
...
/** Implementation of Example 5.6 from "Sparse and Parially Separable
...
private:
  ...
  //@{
  LuksanVlcek6();
  LuksanVlcek6(const LuksanVlcek6&);
  LuksanVlcek6& operator=(const LuksanVlcek6&);
  //@}
